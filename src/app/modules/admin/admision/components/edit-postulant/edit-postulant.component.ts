...
@Component({
  selector: 'app-edit-postulant',
  templateUrl: './edit-postulant.component.html',
  styleUrls: ['./edit-postulant.component.scss']
})
export class EditPostulantComponent implements OnInit {
